...
function Hobelmos({ title, children, className = "" }) {
  return (
    <div className="h-96 w-full mt-12 bg-[url(/images/large-hablemos.jpg)] bg-cover bg-center bg-no-repeat md:mt-20 py-18">
      <div
        className={`container ${className} max-w-7xl mx-auto md:mt-12 md:text-center`}
      >
        <Title
          isH1={false}
          className="text-primary mb-0 md:mb-4 md:text-center text-xl font-bold italic lg:text-3xl"
        >
          {title}
        </Title>
