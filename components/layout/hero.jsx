...
export default function Hero({ title, image, className = "" }) {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex relative justify-start items-center h-full">
        <Title
          isH1={true}
          className="text-[40px] font-black text-white uppercase md:text-[60px] py-18 px-2 md:p-18 z-10 overflow-hidden"
        >
          {title}
        </Title>
        <img
